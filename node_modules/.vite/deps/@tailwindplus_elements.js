...
var Tn = (e, o, t) => o in e ? xn(e, o, { enumerable: true, configurable: true, writable: true, value: t }) : e[o] = t;
var C = (e, o, t) => Tn(e, typeof o != "symbol" ? o + "" : o, t);
var Pt = (e, o, t) => o.has(e) || yo("Cannot " + t);
var f = (e, o, t) => (Pt(e, o, "read from private field"), t ? t.call(e) : o.get(e));
var L = (e, o, t) => o.has(e) ? yo("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(e) : o.set(e, t);
var I = (e, o, t, n) => (Pt(e, o, "write to private field"), n ? n.call(e, t) : o.set(e, t), t);
var M = (e, o, t) => (Pt(e, o, "access private method"), t);
...
function ko(e, o, t) {
  Eo.set(e, setTimeout(() => {
    Eo.has(e) && e.dispatchEvent(new lt("toggle", { cancelable: false, oldState: o, newState: t }));
  }, 0));
}
var Rt = globalThis.ShadowRoot || function() {
};
var Sn = globalThis.HTMLDialogElement || function() {
};
...
function me(e, o) {
  return !(e.popover !== "auto" && e.popover !== "manual" && e.popover !== "hint" || !e.isConnected || o && rt(e) !== "showing" || !o && rt(e) !== "hidden" || e instanceof Sn && e.hasAttribute("open") || document.fullscreenElement === e);
}
function Ao(e) {
  if (!e) return 0;
...
function To(e, o) {
  ...
  function i(s) {
    ...
    for (; !a; ) {
      if (l = Po(s) || null, l === null || !t.has(l)) return;
...
function Mt(e) {
  ...
  let t = false, n = e.popover, r = null, i = To(e, Q.get(o) || /* @__PURE__ */ new Set()), s = To(e, F.get(o) || /* @__PURE__ */ new Set());
  ...
  e.classList.add(":popover-open"), Se.set(e, "showing"), nt.has(o) || nt.set(o, /* @__PURE__ */ new Set()), nt.get(o).add(e), Oo(it.get(e), true), Dn(e), t && a && e.popover === "auto" && st.set(e, a), ko(e, "closed", "open");
}
function Ie(e, o = false, t = false) {
  ...
  if (Oo(it.get(e), false), it.delete(e), t && (e.dispatchEvent(new lt("beforetoggle", { oldState: "open", newState: "closed" })), a && Ve(s) !== e && he(e, o, t), !me(e, true))) return;
...
function Cn(e, o = false, t = false) {
  let n = We(e);
  for (; n; ) Ie(n, o, t), n = We(e);
}
function Ht(e, o = false, t = false) {
  let n = xo(e);
  for (; n; ) Ie(n, o, t), n = xo(e);
}
function So(e, o, t, n) {
  let r = false, i = false;
  for (; r || !i; ) {
...
function he(e, o, t) {
  ...
  if (e instanceof Document) return Cn(i, o, t);
  if ((n = F.get(i)) != null && n.has(e)) {
    So(e, F.get(i), o, t);
    return;
  }
  Ht(F.get(i) || /* @__PURE__ */ new Set(), o, t), (r = Q.get(i)) != null && r.has(e) && So(e, Q.get(i), o, t);
}
...
var Io = globalThis.ShadowRoot || function() {
};
function Do() {
...
function Co() {
  ...
  function e(l) {
    return l?.includes(":popover-open") && (l = l.replace(Mn, "$1.\\:popover-open")), l;
  }
  ...
  function r(l) {
    Object.defineProperties(l.prototype, { popoverTargetElement: { enumerable: true, configurable: true, set(u) {
      ...
      let h = Le(this), v = this.getAttribute("popovertarget");
      return (h instanceof Document || h instanceof Io) && v && h.getElementById(v) || null;
  ...
  let i = (l) => {
    ...
    let u = l.composedPath(), h = u[0];
    if (!(h instanceof Element) || h?.shadowRoot) return;
    let v = Le(h);
    if (!(v instanceof Io || v instanceof Document)) return;
    let c = u.find((g) => {
      var d;
      return (d = g.matches) == null ? void 0 : d.call(g, "[popovertargetaction],[popovertarget]");
    });
    if (c) {
      Ln(c), l.preventDefault();
      return;
    }
  }, s = (l) => {
    let u = l.key, h = l.target;
    !l.defaultPrevented && h && (u === "Escape" || u === "Esc") && he(h.ownerDocument, true, true);
  };
  ((l) => {
    l.addEventListener("click", i), l.addEventListener("keydown", s), l.addEventListener("pointerdown", Lo), l.addEventListener("pointerup", Lo);
...
function Ho() {
  ...
  function e(d, p, m = true) {
    Object.defineProperty(d, p, { ...Object.getOwnPropertyDescriptor(d, p), enumerable: m });
  }
  function o(d) {
  ...
  class r extends Event {
    ...
    get source() {
      ...
      let m = o(p);
      return m !== o(this.target || document) ? m.host : p;
    }
    get command() {
  ...
  class i extends Event {
    constructor(p, m = {}) {
      throw super(p, m), new Error("InvokeEvent has been deprecated, it has been renamed to `CommandEvent`");
    }
  }
  let s = /* @__PURE__ */ new WeakMap();
  function a(d) {
    Object.defineProperties(d.prototype, { commandForElement: { enumerable: true, configurable: true, set(p) {
      ...
      if (p === null) this.removeAttribute("commandfor"), s.delete(this);
      else if (p instanceof Element) {
        this.setAttribute("commandfor", "");
        let m = o(p);
        o(this) === m || m === this.ownerDocument ? s.set(this, p) : s.delete(this);
      ...
      let p = s.get(this);
      if (p) return p.isConnected ? p : (s.delete(this), null);
      let m = o(this), w = this.getAttribute("commandfor");
      return (m instanceof Document || m instanceof ShadowRoot) && w && m.getElementById(w) || null;
    } }, command: { enumerable: true, configurable: true, get() {
      let p = this.getAttribute("command") || "";
  ...
  Object.defineProperties(HTMLElement.prototype, { oncommand: { enumerable: true, configurable: true, get() {
    return h.takeRecords(), l.get(this) || null;
  }, set(d) {
    let p = l.get(this) || null;
    p && this.removeEventListener("command", p), l.set(this, typeof d == "object" || typeof d == "function" ? d : null), typeof d == "function" && this.addEventListener("command", d);
  } } });
  function u(d) {
    for (let p of d) p.oncommand = new Function("event", p.getAttribute("oncommand"));
  }
  let h = new MutationObserver((d) => {
    for (let p of d) {
      let { target: m } = p;
      p.type === "childList" ? u(m.querySelectorAll("[oncommand]")) : u([m]);
    }
  });
  h.observe(document, { subtree: true, childList: true, attributeFilter: ["oncommand"] }), u(document.querySelectorAll("[oncommand]"));
  function v(d) {
    if (d.defaultPrevented || d.type !== "click") return;
    let p = d.target.closest("button[invoketarget], button[invokeaction], input[invoketarget], input[invokeaction]");
    if (p && (console.warn("Elements with `invoketarget` or `invokeaction` are deprecated and should be renamed to use `commandfor` and `command` respectively"), p.matches("input"))) throw new Error("Input elements no longer support `commandfor`");
    let m = d.target.closest("button[commandfor], button[command]");
    if (!m) return;
    if (m.form && m.getAttribute("type") !== "button") throw d.preventDefault(), new Error("Element with `commandFor` is a form participant. It should explicitly set `type=button` in order for `commandFor` to work. In order for it to act as a Submit button, it must not have command or commandfor attributes");
    if (m.hasAttribute("command") !== m.hasAttribute("commandfor")) {
      let A = m.hasAttribute("command") ? "command" : "commandfor", E = m.hasAttribute("command") ? "commandfor" : "command";
      throw new Error(`Element with ${A} attribute must also have a ${E} attribute to function.`);
    }
    if (m.command !== "show-popover" && m.command !== "hide-popover" && m.command !== "toggle-popover" && m.command !== "show-modal" && m.command !== "close" && !m.command.startsWith("--")) {
      console.warn(`"${m.command}" is not a valid command value. Custom commands must begin with --`);
      return;
    }
    let w = m.commandForElement;
    if (!w) return;
    let y = new r("command", { command: m.command, source: m, cancelable: true });
    if (w.dispatchEvent(y), y.defaultPrevented) return;
    let b = y.command.toLowerCase();
    if (w.popover) {
      let A = !w.matches(":popover-open");
      A && (b === "toggle-popover" || b === "show-popover") ? w.showPopover({ source: m }) : !A && b === "hide-popover" && w.hidePopover();
  ...
  function c(d) {
    d.addEventListener("click", v, true);
  }
  function g(d, p) {
    let m = d.prototype.attachShadow;
    ...
    d.prototype.attachInternals = function() {
      let y = w.call(this);
      return y.shadowRoot && p(y.shadowRoot), y;
    };
  }
  a(HTMLButtonElement), g(HTMLElement, (d) => {
    c(d), h.observe(d, { attributeFilter: ["oncommand"] }), u(d.querySelectorAll("[oncommand]"));
...
typeof globalThis.window < "u" && (Do() || (Co(), at(async () => {
  if (await Bn("popover-polyfill")) return;
...
var Ue = Math.floor;
var $ = (e) => ({ x: e, y: e });
var Vn = { left: "right", right: "left", bottom: "top", top: "bottom" };
var Wn = { start: "end", end: "start" };
function Bt(e, o, t) {
  return J(e, Oe(o, t));
}
function ft(e, o) {
...
var $n = /* @__PURE__ */ new Set(["top", "bottom"]);
function se(e) {
  return $n.has(be(e)) ? "y" : "x";
}
function qt(e) {
  return Nt(se(e));
}
...
function Wo(e, o, t, n) {
  let r = dt(e), i = Un(be(e), t === "start", n);
  return r && (i = i.map((s) => s + "-" + r), o && (i = i.concat(i.map(ct)))), i;
}
function _e(e) {
  return e.replace(/left|right|bottom|top/g, (o) => Vn[o]);
}
function jn(e) {
...
function _o(e, o, t) {
  let { reference: n, floating: r } = e, i = se(o), s = qt(o), a = Ft(s), l = be(o), u = i === "y", h = n.x + n.width / 2 - r.width / 2, v = n.y + n.height / 2 - r.height / 2, c = n[a] / 2 - r[a] / 2, g;
  switch (l) {
    case "top":
      g = { x: h, y: n.y - r.height };
      break;
    case "bottom":
...
var Ko = async (e, o, t) => {
  let { placement: n = "bottom", strategy: r = "absolute", middleware: i = [], platform: s } = t, a = i.filter(Boolean), l = await (s.isRTL == null ? void 0 : s.isRTL(o)), u = await s.getElementRects({ reference: e, floating: o, strategy: r }), { x: h, y: v } = _o(u, n, l), c = n, g = {}, d = 0;
  for (let p = 0; p < a.length; p++) {
    let { name: m, fn: w } = a[p], { x: y, y: b, data: A, reset: E } = await w({ x: h, y: v, initialPlacement: n, placement: c, strategy: r, middlewareData: g, rects: u, platform: s, elements: { reference: e, floating: o } });
    h = y ?? h, v = b ?? v, g = { ...g, [m]: { ...g[m], ...A } }, E && d <= 50 && (d++, typeof E == "object" && (E.placement && (c = E.placement), E.rects && (u = E.rects === true ? await s.getElementRects({ reference: e, floating: o, strategy: r }) : E.rects), { x: h, y: v } = _o(u, c, l)), p = -1);
  }
  return { x: h, y: v, placement: c, strategy: r, middlewareData: g };
};
async function Vt(e, o) {
  var t;
  o === void 0 && (o = {});
  let { x: n, y: r, platform: i, rects: s, elements: a, strategy: l } = e, { boundary: u = "clippingAncestors", rootBoundary: h = "viewport", elementContext: v = "floating", altBoundary: c = false, padding: g = 0 } = ft(o, e), d = $o(g), m = a[c ? v === "floating" ? "reference" : "floating" : v], w = ve(await i.getClippingRect({ element: (t = await (i.isElement == null ? void 0 : i.isElement(m))) == null || t ? m : m.contextElement || await (i.getDocumentElement == null ? void 0 : i.getDocumentElement(a.floating)), boundary: u, rootBoundary: h, strategy: l })), y = v === "floating" ? { x: n, y: r, width: s.floating.width, height: s.floating.height } : s.reference, b = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(a.floating)), A = await (i.isElement == null ? void 0 : i.isElement(b)) ? await (i.getScale == null ? void 0 : i.getScale(b)) || { x: 1, y: 1 } : { x: 1, y: 1 }, E = ve(i.convertOffsetParentRelativeRectToViewportRelativeRect ? await i.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: a, rect: y, offsetParent: b, strategy: l }) : y);
...
var Uo = function(e) {
  return e === void 0 && (e = {}), { name: "flip", options: e, async fn(o) {
    var t, n;
    let { placement: r, middlewareData: i, rects: s, initialPlacement: a, platform: l, elements: u } = o, { mainAxis: h = true, crossAxis: v = true, fallbackPlacements: c, fallbackStrategy: g = "bestFit", fallbackAxisSideDirection: d = "none", flipAlignment: p = true, ...m } = ft(e, o);
    if ((t = i.arrow) != null && t.alignmentOffset) return {};
    let w = be(r), y = se(a), b = be(a) === a, A = await (l.isRTL == null ? void 0 : l.isRTL(u.floating)), E = c || (b || !p ? [_e(a)] : Vo(a)), S = d !== "none";
    !c && S && E.push(...Wo(a, p, d, A));
    let H = [a, ...E], ce = await Vt(o, m), D = [], ne = ((n = i.flip) == null ? void 0 : n.overflows) || [];
    if (h && D.push(ce[w]), v) {
      let fe = qo(r, s, A);
    ...
    if (ne = [...ne, { placement: r, overflows: D }], !D.every((fe) => fe <= 0)) {
      var bo, vo;
      let fe = (((bo = i.flip) == null ? void 0 : bo.index) || 0) + 1, kt = H[fe];
      if (kt && (!(v === "alignment" ? y !== se(kt) : false) || ne.every((W) => se(W.placement) === y ? W.overflows[0] > 0 : true))) return { data: { index: fe, overflows: ne }, reset: { placement: kt } };
      let qe = (vo = ne.filter((de) => de.overflows[0] <= 0).sort((de, W) => de.overflows[1] - W.overflows[1])[0]) == null ? void 0 : vo.placement;
      if (!qe) switch (g) {
        case "bestFit": {
          var wo;
          let de = (wo = ne.filter((W) => {
            if (S) {
              let re = se(W.placement);
              return re === y || re === "y";
            }
            return true;
          }).map((W) => [W.placement, W.overflows.filter((re) => re > 0).reduce((re, An) => re + An, 0)]).sort((W, re) => W[1] - re[1])[0]) == null ? void 0 : wo[0];
          de && (qe = de);
          break;
        }
...
var jo = function(e) {
  return e === void 0 && (e = {}), { name: "shift", options: e, async fn(o) {
    let { x: t, y: n, placement: r } = o, { mainAxis: i = true, crossAxis: s = false, limiter: a = { fn: (m) => {
      let { x: w, y } = m;
      return { x: w, y };
    } }, ...l } = ft(e, o), u = { x: t, y: n }, h = await Vt(o, l), v = se(be(r)), c = Nt(v), g = u[c], d = u[v];
    if (i) {
      let m = c === "y" ? "top" : "left", w = c === "y" ? "bottom" : "right", y = g + h[m], b = g - h[w];
      g = Bt(y, g, b);
    }
    if (s) {
      let m = v === "y" ? "top" : "left", w = v === "y" ? "bottom" : "right", y = d + h[m], b = d - h[w];
      d = Bt(y, d, b);
    }
    let p = a.fn({ ...o, [c]: g, [v]: d });
    return { ...p, data: { x: p.x - t, y: p.y - n, enabled: { [c]: i, [v]: s } } };
  } };
};
function pt() {
...
function _(e) {
  var o;
  return (o = (Go(e) ? e.ownerDocument : e.document) || window.document) == null ? void 0 : o.documentElement;
}
function Go(e) {
...
var zn = /* @__PURE__ */ new Set(["inline", "contents"]);
function Ce(e) {
  let { overflow: o, overflowX: t, overflowY: n, display: r } = V(e);
  return /auto|scroll|overlay|hidden|clip/.test(o + n + t) && !zn.has(r);
}
var Gn = /* @__PURE__ */ new Set(["table", "td", "th"]);
function Yo(e) {
  return Gn.has(we(e));
}
var Yn = [":popover-open", ":modal"];
function je(e) {
  return Yn.some((o) => {
    try {
      return e.matches(o);
...
var Qn = ["transform", "translate", "scale", "rotate", "perspective"];
var Xn = ["transform", "translate", "scale", "rotate", "perspective", "filter"];
var Jn = ["paint", "layout", "strict", "content"];
function mt(e) {
  let o = ht(), t = q(e) ? V(e) : e;
  return Qn.some((n) => t[n] ? t[n] !== "none" : false) || (t.containerType ? t.containerType !== "normal" : false) || !o && (t.backdropFilter ? t.backdropFilter !== "none" : false) || !o && (t.filter ? t.filter !== "none" : false) || Xn.some((n) => (t.willChange || "").includes(n)) || Jn.some((n) => (t.contain || "").includes(n));
}
function Qo(e) {
  let o = Z(e);
  for (; K(o) && !ye(o); ) {
...
var Zn = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function ye(e) {
  return Zn.has(we(e));
}
function V(e) {
...
function Z(e) {
  ...
  let o = e.assignedSlot || e.parentNode || zo(e) && e.host || _(e);
  return zo(o) ? o.host : o;
}
function Xo(e) {
  let o = Z(e);
  return ye(o) ? e.ownerDocument ? e.ownerDocument.body : e.body : K(o) && Ce(o) ? o : Xo(o);
}
function De(e, o, t) {
  var n;
  o === void 0 && (o = []), t === void 0 && (t = true);
  let r = Xo(e), i = r === ((n = e.ownerDocument) == null ? void 0 : n.body), s = R(r);
  if (i) {
    let a = gt(s);
...
function Me(e) {
  let o = $t(e);
  if (!K(o)) return $(1);
  let t = o.getBoundingClientRect(), { width: n, height: r, $: i } = en(o), s = (i ? Ke(t.width) : t.width) / n, a = (i ? Ke(t.height) : t.height) / r;
  return (!s || !Number.isFinite(s)) && (s = 1), (!a || !Number.isFinite(a)) && (a = 1), { x: s, y: a };
}
var er = $(0);
function tn(e) {
  let o = R(e);
  return !ht() || !o.visualViewport ? er : { x: o.visualViewport.offsetLeft, y: o.visualViewport.offsetTop };
}
function tr(e, o, t) {
...
function Ee(e, o, t, n) {
  ...
  let a = tr(i, t, n) ? tn(i) : $(0), l = (r.left + a.x) / s.x, u = (r.top + a.y) / s.y, h = r.width / s.x, v = r.height / s.y;
  if (i) {
    let c = R(i), g = n && q(n) ? R(n) : n, d = c, p = gt(d);
    for (; p && n && g !== d; ) {
      let m = Me(p), w = p.getBoundingClientRect(), y = V(p), b = w.left + (p.clientLeft + parseFloat(y.paddingLeft)) * m.x, A = w.top + (p.clientTop + parseFloat(y.paddingTop)) * m.y;
      l *= m.x, u *= m.y, h *= m.x, v *= m.y, l += b, u += A, d = R(p), p = gt(d);
    }
  }
  return ve({ width: h, height: v, x: l, y: u });
}
function _t(e, o) {
...
function or(e) {
  ...
  if (n === s || a && i) return t;
  let l = { scrollLeft: 0, scrollTop: 0 }, u = $(1), h = $(0), v = K(n);
  if ((v || !v && !i) && ((we(n) !== "body" || Ce(s)) && (l = ze(n)), K(n))) {
    let g = Ee(n);
    u = Me(n), h.x = g.x + n.clientLeft, h.y = g.y + n.clientTop;
  }
  let c = s && !v && !i ? on(s, l, true) : $(0);
  return { width: t.width * u.x, height: t.height * u.y, x: t.x * u.x - l.scrollLeft * u.x + h.x + c.x, y: t.y * u.y - l.scrollTop * u.y + h.y + c.y };
}
function nr(e) {
...
var sr = /* @__PURE__ */ new Set(["absolute", "fixed"]);
function lr(e, o) {
...
function Jo(e, o, t) {
  let n;
  if (o === "viewport") n = ir(e, t);
  else if (o === "document") n = rr(_(e));
  else if (q(o)) n = lr(o, t);
  else {
    let r = tn(e);
...
function nn(e, o) {
  let t = Z(e);
  return t === o || !q(t) || ye(t) ? false : V(t).position === "fixed" || nn(t, o);
}
function ar(e, o) {
  let t = o.get(e);
  if (t) return t;
  ...
  for (; q(s) && !ye(s); ) {
    let a = V(s), l = mt(s);
    !l && a.position === "fixed" && (r = null), (i ? !l && !r : !l && a.position === "static" && !!r && sr.has(r.position) || Ce(s) && !l && nn(e, s)) ? n = n.filter((h) => h !== s) : r = a, s = Z(s);
  }
  return o.set(e, n), n;
}
function ur(e) {
  let { element: o, boundary: t, rootBoundary: n, strategy: r } = e, s = [...t === "clippingAncestors" ? je(o) ? [] : ar(o, this._c) : [].concat(t), n], a = s[0], l = s.reduce((u, h) => {
    let v = Jo(o, h, r);
    return u.top = J(v.top, u.top), u.right = Oe(v.right, u.right), u.bottom = Oe(v.bottom, u.bottom), u.left = J(v.left, u.left), u;
  }, Jo(o, a, r));
  return { width: l.right - l.left, height: l.bottom - l.top, x: l.left, y: l.top };
}
function cr(e) {
  let { width: o, height: t } = en(e);
...
function fr(e, o, t) {
  ...
  i && !n && r && u();
  let h = r && !n && !i ? on(r, a) : $(0), v = s.left + a.scrollLeft - l.x - h.x, c = s.top + a.scrollTop - l.y - h.y;
  return { x: v, y: c, width: s.width, height: s.height };
}
function Wt(e) {
...
function rn(e, o) {
  ...
  let n = Zo(e, o);
  for (; n && Yo(n) && Wt(n); ) n = Zo(n, o);
  return n && ye(n) && Wt(n) && !mt(n) ? t : n || Qo(e) || t;
}
var dr = async function(e) {
  let o = this.getOffsetParent || rn, t = this.getDimensions, n = await t(e.floating);
  return { reference: fr(e.reference, await o(e.floating), e.strategy), floating: { x: 0, y: 0, width: n.width, height: n.height } };
};
function pr(e) {
  return V(e).direction === "rtl";
}
var mr = { convertOffsetParentRelativeRectToViewportRelativeRect: or, getDocumentElement: _, getClippingRect: ur, getOffsetParent: rn, getElementRects: dr, getClientRects: nr, getDimensions: cr, getScale: Me, isElement: q, isRTL: pr };
function sn(e, o) {
...
function hr(e, o) {
  ...
  function s(a, l) {
    ...
    let u = e.getBoundingClientRect(), { left: h, top: v, width: c, height: g } = u;
    if (a || o(), !c || !g) return;
    let d = Ue(v), p = Ue(r.clientWidth - (h + c)), m = Ue(r.clientHeight - (v + g)), w = Ue(h), b = { rootMargin: -d + "px " + -p + "px " + -m + "px " + -w + "px", threshold: J(0, Oe(1, l)) || 1 }, A = true;
    function E(S) {
      ...
      H === 1 && !sn(u, e.getBoundingClientRect()) && s(), A = false;
    }
    try {
...
function ln(e, o, t, n) {
  n === void 0 && (n = {});
  let { ancestorScroll: r = true, ancestorResize: i = true, elementResize: s = typeof ResizeObserver == "function", layoutShift: a = typeof IntersectionObserver == "function", animationFrame: l = false } = n, u = $t(e), h = r || i ? [...u ? De(u) : [], ...De(o)] : [];
  h.forEach((w) => {
    r && w.addEventListener("scroll", t, { passive: true }), i && w.addEventListener("resize", t);
  });
  let v = u && a ? hr(u, t) : null, c = -1, g = null;
  s && (g = new ResizeObserver((w) => {
    let [y] = w;
    y && y.target === u && g && (g.unobserve(o), cancelAnimationFrame(c), c = requestAnimationFrame(() => {
      var b;
      (b = g) == null || b.observe(o);
    })), t();
  }), u && !l && g.observe(u), g.observe(o));
  let d, p = l ? Ee(e) : null;
  l && m();
  function m() {
    let w = Ee(e);
    p && !sn(p, w) && t(), p = w, d = requestAnimationFrame(m);
  }
  return t(), () => {
    var w;
    h.forEach((y) => {
      r && y.removeEventListener("scroll", t), i && y.removeEventListener("resize", t);
    }), v?.(), (w = g) == null || w.disconnect(), g = null, l && cancelAnimationFrame(d);
  };
}
var an = jo;
var un = Uo;
var cn = (e, o, t) => {
  let n = /* @__PURE__ */ new Map(), r = { platform: mr, ...t }, i = { ...r.platform, _c: n };
  return Ko(e, o, { ...r, platform: i });
};
function dn(e, o) {
  let t = () => {
  };
  return function(r) {
    ...
    a !== "absolute" && a !== "fixed" && (console.warn(`[createAnchorUpdater] Invalid anchor strategy "${a}" for element:`, e), a = "absolute"), t = ln(i, e, () => {
      let l = fn(window.getComputedStyle(e).getPropertyValue("--anchor-gap"), e), u = fn(window.getComputedStyle(e).getPropertyValue("--anchor-offset"), e), h = s.split(" ")[0], v = {};
      switch (h) {
        case "top":
        case "bottom":
          v = { top: l, left: -1 * u, right: u, bottom: l };
          break;
        case "left":
        case "right":
          v = { top: -1 * u, bottom: u, left: l, right: l };
          break;
      }
      cn(i, e, { strategy: a, placement: s.replace(" ", "-"), middleware: [un({ padding: v }), an({ padding: v })] }).then(({ x: c, y: g, placement: d }) => {
        if (!gr() && a === "absolute") {
          let w = null;
          ...
          if (w) {
            ...
            c -= y.left + window.scrollX, g -= y.top + window.scrollY;
          }
        }
        let p = `${c}px`, m = `${g}px`;
        switch (d.split("-")[0]) {
          case "top":
            m = `calc(${g}px - var(--anchor-gap, 0px))`, p = `calc(${c}px + var(--anchor-offset, 0px))`;
            break;
          case "right":
            p = `calc(${c}px + var(--anchor-gap, 0px))`, m = `calc(${g}px + var(--anchor-offset, 0px))`;
            break;
          case "bottom":
            m = `calc(${g}px + var(--anchor-gap, 0px))`, p = `calc(${c}px + var(--anchor-offset, 0px))`;
            break;
        ...
        Object.assign(e.style, { left: p, top: m, position: a });
      });
    });
  };
}
...
var Ye = false;
var jt = false;
typeof navigator < "u" && (Ye = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), jt = navigator.userAgent.toLowerCase().includes("firefox"));
var zt = false;
function He(e, o, t, n, r, i) {
  wr(e.ownerDocument);
  let s = Pe(e), a = dn(e, t), l = X();
  e.setAttribute("popover", "");
  let u = o();
  u && (u.setAttribute("type", "button"), u.setAttribute("aria-haspopup", "true"), u.setAttribute("aria-controls", e.id), u.setAttribute("aria-expanded", "false"), u.id && e.setAttribute("aria-labelledby", u.id)), e.hasAttribute("open") && queueMicrotask(() => e.showPopover()), e.addEventListener("beforetoggle", (v) => {
    let c = v;
    a(c.newState === "open");
    let g = e.hasAttribute("open");
    c.newState === "open" && !g ? e.setAttributeNoCallbacks("open", "") : c.newState === "closed" && g && e.removeAttributeNoCallbacks("open"), c.newState === "open" ? (u?.setAttribute("aria-expanded", "true"), r?.(), zt = e.getAttribute("popover") === "") : (u?.setAttribute("aria-expanded", "false"), i?.(), zt = false), c.oldState === "closed" && c.newState === "open" ? (Ye && (l.dispose(), l = X()), s.start("in")) : c.oldState === "open" && c.newState === "closed" && (Ye && l.style(e, "transition-property", "none"), s.start("out"));
  }, { signal: n });
  function h() {
    e.hasAttribute("open") && e.hidePopover();
  }
  le(e, n, h), u && le(u, n, h), n.addEventListener("abort", () => s.abort());
}
...
function wr(e) {
  ...
  e.addEventListener("mousedown", () => {
    jt || Ye || !zt || (e.body.setAttribute("tabindex", "-1"), o && clearTimeout(o), o = setTimeout(() => e.body.removeAttribute("tabindex")));
  }, { capture: true });
}
function U(e, o, t, n) {
  function r() {
...
function ae(e, o, t, n) {
  Ar(), e.addEventListener(o, (r) => {
    Gt !== null && Date.now() - Gt < Er || n(r);
  }, { passive: true, signal: t });
}
var Gt = null;
var vn = false;
function Ar() {
  vn || (vn = true, document.addEventListener("keydown", () => {
    Gt = Date.now();
  }, { capture: true }));
}
...
var wn = new bt(() => ({ referenceCounter: 0, d: X() }));
function vt(e) {
  let o = wn.get(e);
  ...
  let t = false;
  return () => {
    t || (t = true, o.referenceCounter--, !(o.referenceCounter > 0) && (o.d.dispose(), wn.delete(e)));
  };
}
function xr() {
  ...
  return Sr() ? { before({ doc: e, d: o }) {
    ...
    o.microTask(() => {
      ...
      o.addEventListener(e, "click", (i) => {
        ...
        if (Ge(i.target) && pn(i.target)) if (t(i.target)) {
          let s = i.target;
...
function yt(e) {
  ...
  return yn.test(r) && (r = r.replace(yn, "")), r;
}
function En(e) {
...
var Yt = class extends x {
  ...
  mount(t) {
    ...
    n.addEventListener("pointerdown", h, { signal: t }), r && (r.addEventListener("pointerdown", (c) => {
      c.preventDefault(), h();
    ...
    let v = Array.from(i.querySelectorAll("el-option[disabled]"));
    for (let c of v) c.setAttribute("aria-disabled", "true"), c.setAttribute("aria-selected", "false");
...
var Xt = class extends x {
  ...
  mount(t) {
    ...
    function s() {
      var l;
      for (let u of r.getItems()) u.getAttribute("role") !== "option" && (u.id || (u.id = k("item")), u.setAttribute("role", "option"), u.setAttribute("tabIndex", "-1"), u.setAttribute("aria-selected", "false"), u.hasAttribute("disabled") && u.setAttribute("aria-disabled", "true"), ae(u, "mouseover", t, () => {
        var h;
        return M(h = i, ee, Jt).call(h, u, false);
      }));
      M(l = i, ee, Et).call(l, true);
    }
    s();
...
T("el-command-palette", Xt);
T("el-command-list", Zt);
T("el-defaults", eo);
T("el-no-results", to);
T("el-command-group", no);
T("el-command-preview", oo);
var z = [];
at(() => {
  function e(o) {
...
var Be = class extends x {
  ...
  mount(t) {
    ...
    for (let a of M(this, Ze, ro).call(this)) a.setAttribute("aria-expanded", r.toString());
    kr(n, t, (a) => {
      a.preventDefault();
  ...
  onAttributeChange(t, n, r) {
    switch (t) {
      case "open": {
        ...
        for (let s of M(this, Ze, ro).call(this)) s.setAttribute("aria-expanded", r !== null ? "true" : "false");
...
Y = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap(), Ne = /* @__PURE__ */ new WeakMap(), Ae = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakSet(), ro = function() {
...
T("el-dialog", Be);
T("el-dialog-panel", io);
T("el-dialog-backdrop", so);
function Ir(e, o, t) {
...
var At = class extends x {
  ...
  mount(t) {
    ...
    for (let i of M(this, et, lo).call(this)) le(i, t, n), i.setAttribute("aria-expanded", r.toString()), i.setAttribute("aria-controls", this.id);
  ...
  onAttributeChange(t, n, r) {
    switch (t) {
      case "hidden": {
        ...
        for (let i of M(this, et, lo).call(this)) i.setAttribute("aria-expanded", r === null ? "true" : "false");
...
Fe = /* @__PURE__ */ new WeakMap(), et = /* @__PURE__ */ new WeakSet(), lo = function() {
...
function xt(e, o, t, n, r) {
  ...
  e.ownerDocument.addEventListener("focusin", (a) => {
    ...
    l !== null && (i && Date.now() < i || e.contains(l) || o.some((h) => h.contains(l)) || r(u));
  }, { signal: n });
}
var Pr = 200;
function Tt(e, o, t) {
  ...
  function l() {
    ...
    for (let S of b) S.getAttribute("role") !== E && (S.id || (S.id = k("item")), S.setAttribute("role", E), S.setAttribute("tabIndex", "-1"), S.addEventListener("click", () => o.onItemClick(S), A), ae(S, "mouseover", t, () => g(S, false)), ae(S, "mouseout", t, () => d()));
  }
  l();
  let u = new MutationObserver(l);
  ...
  function m(b, A = false) {
    if (b === "") return null;
    let E = o.getItems(), S = b.toLowerCase(), H = p(), ce = H ? E.indexOf(H) : -1;
  ...
  return { ignoreNextFocusRestoration: () => s = Date.now() + 100, setActiveItem: g, clearActiveItem: d, getActiveItem: p, findItemBySearchQuery: m, handleSearchKey: w, hasActiveSearchQuery: y };
}
var oe;
var xe;
var P;
...
var tt = class extends x {
  ...
  set value(t) {
    I(this, xe, t), f(this, oe).setFormValue(t), M(this, ot, ao).call(this);
...
oe = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), ot = /* @__PURE__ */ new WeakSet(), ao = function() {
  if (!this.hasAttribute("required") || f(this, xe)) {
    f(this, oe).setValidity({});
    return;
  }
  f(this, oe).setValidity({ valueMissing: true }, hn.selectRequired, this.getButton());
