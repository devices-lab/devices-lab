...
<BaseCard class="flex items-start">
	<div class="max-h-60 w-60">
		{#if item.picture}
			<BaseImg src={item.picture} alt="" class="rounded-lg dark:outline dark:-outline-offset-1 dark:outline-white/10" />
		{/if}
	</div>
