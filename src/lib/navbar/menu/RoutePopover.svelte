...
<ClassBox {props} class="group/popover inline-flex">
	<RouteLink {route} button={{ props: { popovertarget: popoverID }, class: 'group-has-open/popover:border-b-3  group-has-open/popover:bg-current/10 group-has-open/popover:font-bold' }} />
	<!-- Popover content -->
