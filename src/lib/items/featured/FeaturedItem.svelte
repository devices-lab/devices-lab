...
<div class="group relative">
	<BaseLink slug={item.slug} type={item.route.type} class="isolate z-10 flex max-w-2xl flex-col gap-x-8 gap-y-2 transition-all duration-300 hover:translate-y-1 sm:flex-row sm:items-start lg:flex-col lg:items-stretch">
		<BaseImg src={item.cover} alt="" class="aspect-2/1 w-full rounded-lg object-contain group-hover:opacity-70 sm:aspect-video sm:h-32 lg:h-auto" />
