...
{#key entry}
	<BaseCard link={{ href: entry.path }} class="flex aspect-square max-w-xs flex-col items-center justify-between overflow-hidden sm:p-4">
		...
		<div class="absolute inset-0 flex w-full flex-col justify-end bg-gradient-to-b from-slate-500/0 from-0% to-black/0 to-85% p-4 text-sm opacity-0 group-hover:opacity-90 sm:p-6">
