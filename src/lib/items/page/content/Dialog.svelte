...
<el-dialog>
	<dialog id={dialogId} onclose={onDialogClose} aria-labelledby="dialog-title" class="fixed inset-0 size-auto top-0 max-h-none max-w-none overflow-y-auto bg-transparent backdrop:bg-transparent">
		<el-dialog-backdrop class="fixed inset-0 bg-gray-500/75 transition-opacity data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in dark:bg-gray-900/50 -z-1"></el-dialog-backdrop>
