...
<InputGroup label="Border">
	...
	<NumberInput 	label={{label: "Radius TL", pre: Triangle, post: SquareArrowUpLeft, postClass: 'size-4.5 ms-1 text-primary-500'}} 	
		bind:value={border.topL.dRadius} 		initial={defaults.topL.dRadius} 	min={-border.radius} 	max={maxRadiusTopLeft - border.radius} />
	<NumberInput 	label={{label: "Radius TR", pre: Triangle, post: SquareArrowUpRight, postClass: 'size-4.5 ms-1 text-primary-500'}} 	
		bind:value={border.topR.dRadius} 		initial={defaults.topR.dRadius} 	min={-border.radius} 	max={maxRadiusTopRight - border.radius} />
	<NumberInput 	label={{label: "Radius BL", pre: Triangle, post: SquareArrowDownLeft, postClass: 'size-4.5 ms-1 text-primary-500'}} 	
	...
	<NumberInput 	label={{label: "Radius BR", pre: Triangle, post: SquareArrowDownRight, postClass: 'size-4.5 ms-1 text-primary-500'}} 	
