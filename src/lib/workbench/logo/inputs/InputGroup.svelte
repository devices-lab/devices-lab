...
<div class="rounded-lg px-0">
	<button type="button" command="--toggle" commandfor={uid} class="group relative mb-2 flex cursor-pointer items-center justify-between text-left">
		<span class="flex w-full items-center border-b-0 border-gray-200 font-semibold not-in-aria-expanded:text-gray-900 in-aria-expanded:text-primary dark:border-gray-700 dark:not-in-aria-expanded:text-gray-300">
			{labelText}
