<script lang="ts">
	...
	import { exportPng } from '$lib/tools/logo/export/image';
	import { exportSvgForKiCad } from '$lib/tools/logo/export/kicad';
	import { exportDxfForAltium } from '$lib/tools/logo/export/altium';
	import { exportSvg, exportSvgFlat, exportSvgFont } from '$lib/tools/logo/export/svg';
