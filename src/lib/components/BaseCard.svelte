...
{#snippet Content()}
	<div {...rest.props} class={cn("group relative overflow-hidden rounded-3xl bg-white text-gray-900 shadow dark:bg-gray-800 dark:text-gray-100 dark:shadow-none", hoverClass, rest.class)}>
		{@render children()}
	</div>
{/snippet}
